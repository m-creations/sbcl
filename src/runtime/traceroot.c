                ...
                lispobj ignored_objects, int criterion)
{
    ...
    ensure_region_closed(code_region, TR_PT_ARG(0, PAGE_TYPE_CODE), 22);
    ...
    ensure_region_closed(unboxed_region, TR_PT_ARG(0, PAGE_TYPE_UNBOXED), 23);
    ensure_region_closed(cons_region, TR_PT_ARG(0, PAGE_TYPE_CONS), 24);
